...
function setRstate {
	...
	mv WCDMA-Dashboard/build/feature-release.xml WCDMA-Dashboard/build/feature-release.${rstate}.xml
...
if [ $rsp == 0 ]; then
  ...
  git remote set-url --push origin ssh://esjkadm100@gerrit.ericsson.se:29418/OSS/ENIQ-CR-Parent/OSS/com.ericsson.eniq/WCDMA-Dashboard
